...
from .models import Manga, Category, EbookStore, ScrapingHistory, ScrapedManga, EbookStoreCategoryUrl, MangaEbookStore
...
@admin.register(MangaEbookStore)
class MangaEbookStoreAdmin(admin.ModelAdmin):
