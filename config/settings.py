...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-4c7_1d54a3$b@6y%w3g!pu%orihzg9=#uzg93z5!g80nv)k=0j')
...
if 'DATABASE_URL' in os.environ:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': env('MYSQL_DATABASE', default='free_manga_db'),
            'USER': env('MYSQL_USER', default='root'),
            'PASSWORD': env('MYSQL_ROOT_PASSWORD', default='password'),
